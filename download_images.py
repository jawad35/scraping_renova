...
def fetch_json_from_api(style_number, color_number, product_type_code, product_group_name, unique_param):
...
def download_image(image_url, image_name, save_directory='images'):
    try:
...
if __name__ == "__main__":
    ...
    api_response = fetch_json_from_api(style_number, color_number, product_type_code, product_group_name, unique_param)
