...
def generate_rewrite(description, api_key):
    try:
        ...
        completion = client.completions.create(
            ...
            prompt=f"Please rewrite it just '{description}'",
            max_tokens=100,
            temperature=0
        )
...
urls = [
    "https://www.build.com/daltile-36mod1p-g/s1699315?uid=4010436&searchId=qKuQrQXAaE",
    "https://www.build.com/msi-nste2x10g/s1963910?uid=4648008&searchId=qKuQrQXAaE",
    "https://www.build.com/merola-tile-fdxmhm/s1975564?uid=4686875&searchId=qKuQrQXAaE",
    "https://www.build.com/daltile-p61224p/s1318714?uid=3129487&searchId=qKuQrQXAaE",
    "https://www.build.com/daltile-m0elhexqpmsu/s1751241?uid=4139143&searchId=qKuQrQXAaE"
    # Add more URLs here
]

# Base directory to save images and data
base_image_folder = 'tile'
